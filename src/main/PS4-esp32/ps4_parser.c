...
static ps4_t ps4;
static ps4_event_callback_t ps4_event_cb;
...
ps4_sensor_t parsePacketSensor(uint8_t* packet) {
	...
	ps4Sensor.accelerometer.x = (packet[packet_index_sensor_accelerometer_x] << 8) + packet[packet_index_sensor_accelerometer_x+1] - offset;
	ps4Sensor.accelerometer.y = (packet[packet_index_sensor_accelerometer_y] << 8) + packet[packet_index_sensor_accelerometer_y+1] - offset;
	ps4Sensor.accelerometer.z = (packet[packet_index_sensor_accelerometer_z] << 8) + packet[packet_index_sensor_accelerometer_z+1] - offset;
	ps4Sensor.gyroscope.z     = (packet[packet_index_sensor_gyroscope_z]     << 8) + packet[packet_index_sensor_gyroscope_z+1]     - offset;
	*/
	return ps4Sensor;
}
